    ...
    <div>
      ...
      <section className={styles.dashboard}>
        <article className={styles.dashboard_header}>
          <div>
            <h1>Vaše kurzy</h1>
            <p>{courses.length} kurzy</p>
          </div>
          <DashboardButton link={'/dashboard/new'} text={'Nový kurz'} icon={<svg width="1.75rem" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <CourseDashboardList courses={coursesData} />
      </section>
    </div>
  )
}
