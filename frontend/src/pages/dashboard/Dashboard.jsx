  ...
  return (
    <div>
      ...
      <section className={styles.dashboard}>
        <DashboardNav heading={'Správa kurzů'} desc={courses.length + ' kurzů'} actions={actions} />
