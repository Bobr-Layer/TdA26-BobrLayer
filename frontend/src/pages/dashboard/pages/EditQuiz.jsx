...
export default function EditQuiz({user, setUser}) {
    ...
    const actions = [
        ...
        },
        {
            ...
            onClick: () => navigate('/dashboard/' + uuid + '/quizzes'),
            red: true
        }
    ]
    ...
    return (
        <div>
            ...
            <section className={styles.dashboard}>
                <DashboardNav heading={'Upravit kvíz'} actions={actions} />
                <QuizzForm quizzData={editQuizzData} handleQuizzChange={handleEditQuizzChange} />
            </section>
        </div>
    )
}
