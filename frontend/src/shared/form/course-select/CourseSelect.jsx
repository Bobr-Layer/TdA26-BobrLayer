...
export default function CourseSelect({ courseData, setCourseData, admin }) {
    ...
    return (
        <div className={styles.wrapper}>
            ...
            >
                <option value="">Filtrovat kurzy podle stavu</option>
                {admin && <option value="Draft">Draft</option>}
                <option value="Scheduled">Naplánované</option>
                <option value="Live">Aktivní</option>
                {admin &&
                    <>
